...
export default function CartaGastronomiaPage() {
  ...
  return (
    <main className={`sp-shell ${cormorant.className}`}>
      ...
      <section className="sp-related-cards" aria-label={isEnglish ? "Other menus" : "Outras cartas"}>
        <Link href="/gastronomia/bebidas" className="sp-related-card">
          <span className="sp-related-kicker">{isEnglish ? "Carta" : "Carta"}</span>
          <span className={`sp-related-title ${cinzel.className}`}>
            {isEnglish ? "Beverages" : "Bebidas"}
          </span>
        </Link>

        <Link href="/gastronomia/sobremesas" className="sp-related-card">
          <span className="sp-related-kicker">{isEnglish ? "Carta" : "Carta"}</span>
          <span className={`sp-related-title ${cinzel.className}`}>
            {isEnglish ? "Desserts" : "Sobremesas"}
          </span>
        </Link>
      </section>
      ...
      <style jsx global>{`
        ...
        * {
        ...
        .sp-related-card {
          ...
          overflow: hidden;
          min-height: 86px;
          border: 1px solid rgba(197, 154, 97, 0.72);
          background:
        ...
        .sp-related-card::after {
          ...
          right: 22px;
          height: 1px;
          background: rgba(197, 154, 97, 0.46);
        }
        ...
        .sp-related-card:hover {
          ...
          border-color: rgba(217, 168, 93, 0.96);
          background:
